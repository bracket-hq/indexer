export const BG_Beta_0x3d80Abi = [
  ...
  { inputs: [], name: "CollectiveNotDistributed", type: "error" },
  { inputs: [], name: "FailedInnerCall", type: "error" },
  { inputs: [], name: "InsufficientVotes", type: "error" },
  ...
  { inputs: [], name: "SeasonNotTradeable", type: "error" },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_curveDenominator", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "address", name: "_claimerAccount", type: "address" }],
